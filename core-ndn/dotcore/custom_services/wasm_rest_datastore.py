...
class WasmRest(ConfigService):
    ...
    startup: List[str] = ["bash -c 'python3 /root/wasm_rest/wasm_rest.py datastore --host $(hostname -I | grep -E -o \"[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+\") --rootdir /root/wasm_rest/out &> /root/wasm_rest/out/log.log'"]
